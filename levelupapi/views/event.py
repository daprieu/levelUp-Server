...
from levelupapi.models.gameEvent import GameEvent
...
class EventView(ViewSet):
    ...
    def list(self, request):
        ...
        for event in events:
            ...
            try:
                GameEvent.objects.get(event=event, gamer=gamer)
                event.joined = True
    ...
    def signup(self, request, pk=None):
        ...
        if request.method == "POST":
            ...
            try:
                ...
                registration = GameEvent.objects.get(
